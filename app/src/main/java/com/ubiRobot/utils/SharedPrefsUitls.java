...
//        }
    ...
    public String getUbiToUsdtRate() {
        return mSharedPreferences.getString("UbiToUsdt", "0");

    }

    public void putUbiToUsdtRate(String rate) {
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putString("UbiToUsdt", rate);
        editor.apply();
    }
    ...
    public void putUBIAddress(String address) {
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putString("UBIAddress", address);
        editor.apply();
    }

    public String getUBIAddress() {
        return mSharedPreferences.getString("UBIAddress", "");
    }
