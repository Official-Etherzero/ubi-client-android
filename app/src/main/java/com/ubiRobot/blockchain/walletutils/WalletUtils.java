...
import com.ubiRobot.sqlite.BRSQLiteHelper;
...
import com.ubiRobot.utils.SecureRandomUtils;
...
//                list.add("EASH");
            ...
            if (wallet != null) {
                wallet.setMnemonic(phrase);
                List<String> list = new ArrayList<>();
                if (walletType.equalsIgnoreCase("UBI")) {
                    list.add("UBI");
//                    list.add("EASH");
                } else {
                    list.add("ETH");
    ...
    private static WalletBean generateEtzWallet(String walletName, String pwd, ECKeyPair ecKeyPair) {
        return generateWallet(walletName, pwd, ecKeyPair, "UBI");
    }
