...
public class EtzWalletManager implements BaseWalletManager {
            ...
            public void run() {
                ...
                HttpRequets.postRequest(ethRpcUrl, getClass(), payload.toString(), new JsonCallback<RPCBalanceBean>() {
                    ...
                    public void onSuccess(Response<RPCBalanceBean> response) {
                        ...
                        BalanceDataSource.getInstance().insertTokenBalance(new BalanceEntity(wid + "UBI", wid, "UBI", bigb));
    ...
    public BigDecimal getFiatExchangeRate(Context app, String iso) {
        BigDecimal fiatData = getFiatForEth("UBI", new BigDecimal(1), SharedPrefsUitls.getInstance().getPreferredFiatIso());
    ...
    private BigDecimal getFiatForEth(String iso, BigDecimal ethAmount, String code) {
        ...
        //Btc rate for ether
        CurrencyEntity ethBtcRate = RatesDataSource.getInstance(MyApp.getmInstance()).getCurrencyByCode(MyApp.getmInstance(), "UBI", "BTC");
        if (btcRate == null) {
