package com.ubiRobot.modules.walletmanage;
...
import com.ubiRobot.blockchain.TokenWalletManager;
...
public class WalletsMaster {
    ...
    public BaseWalletManager getWalletByIso(Context app, String iso) {
        ...
        } else if (iso.equalsIgnoreCase("UBI")) {
...
//        MyLog.i( "isIsoCrypto: ios===="+iso);
        ...
        if (iso.equalsIgnoreCase("UBI") || iso.equalsIgnoreCase("ETH")) return true;
        return false;
    }
}
