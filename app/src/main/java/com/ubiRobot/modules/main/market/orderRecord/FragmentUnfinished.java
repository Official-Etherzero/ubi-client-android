...
public class FragmentUnfinished extends BaseFragment<OrderRecordView, OrderRecordPresenter> implements OrderRecordView {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        adapter = new MyOrderRecordAdapter(R.layout.order_record_item_layout, new ArrayList<>(), 1);
    ...
    public void onResume() {
        super.onResume();
        presenter.myrders(SharedPrefsUitls.getInstance().getUserToken(), "1", "0", "150");
    }
    ...
    public void getMyOrders(List<HangOrderBean> beans) {
        if (beans != null && beans.size() > 0) {
            ...
            adapter.setTokens(new ArrayList<>());
