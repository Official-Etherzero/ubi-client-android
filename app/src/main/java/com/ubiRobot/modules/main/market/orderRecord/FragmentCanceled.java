...
public class FragmentCanceled extends BaseFragment<OrderRecordView, OrderRecordPresenter> implements OrderRecordView {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        adapter = new MyOrderRecordAdapter(R.layout.order_record_item_layout, new ArrayList<>(), 3);
...
//                startActivity(intent);
    ...
    public void onResume() {
        super.onResume();
        presenter.myrders(SharedPrefsUitls.getInstance().getUserToken(), "3", "0", "100");
    }
