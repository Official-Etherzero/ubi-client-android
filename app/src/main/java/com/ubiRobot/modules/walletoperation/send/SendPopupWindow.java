...
import com.ubiRobot.BuildConfig;
...
import com.ubiRobot.bean.CryptoRequest;
...
import com.ubiRobot.modules.walletoperation.ConfirmationViewModel;
...
import static com.ubiRobot.utils.CryptoUriParser.parseRequest;
...
//        viewModel = new ConfirmationViewModel(createTransaction);
        isSendingTokens = !tokenInfo.symbol.equals("UBI");
        init(context);
        setPopupWindow();
...
//                        json.put("value", "0x" + new BigInteger("0", 10).toString(16));
    ...
    private void onErrorTransaction(Throwable throwable) {
        ToastUtils.showLongToast(ctx,"transaction failed：" + throwable.getMessage());
    }
